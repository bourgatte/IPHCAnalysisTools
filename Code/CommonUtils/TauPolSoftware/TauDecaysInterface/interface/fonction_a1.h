...
std::vector<TLorentzVector> tauPairMomentumSolutions(const TVector3 &tau1Dir, const TLorentzVector &a1LV1, bool is1Real, const TVector3 &tau2Dir, const TLorentzVector &a1LV2, bool is2Real);
